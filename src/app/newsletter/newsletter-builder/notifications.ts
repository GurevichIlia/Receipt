...
// //       error = (text, id, params) => this.showNotification(this.getErrorNotification.bind(this), text, id, params);
...
// //       },
// //       success = (text, id, params) => {
// //             this.showNotification(this.getSuccessNotification.bind(this), text, id, params);
// //       },
// //       loader = (text, id, params) => {
// //             this.showNotification(this.getLoaderNotification.bind(this), text, id, params);
// //       },
// //       hide = (id) => {
// //             const toast = $('#' + id, this.container);
// //             toast.effect('fade', 600, () => toast.remove())
// //       }


// //       showNotification: (notificationGetter, text, id, params) => {
...
// //                               getNotificationTemplate = (classes, text, id, nonclosable) {
// //                                     var notification = $('\
